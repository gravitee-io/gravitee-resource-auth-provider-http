...
public class HttpAuthenticationProviderResource
  ...
  private final Logger logger = LoggerFactory.getLogger(
    HttpAuthenticationProviderResource.class
  );
  ...
  public void authenticate(
    ...
    HttpClientRequest request = httpClient
      .requestAbs(
        convert(configuration().getMethod()),
              ...
              new io.vertx.core.Handler<Buffer>() {
                ...
                public void handle(Buffer body) {
                  ...
                  tplEngine
                    ...
                    .setVariable(
                      TEMPLATE_VARIABLE,
                      new AuthenticationResponse(httpResponse, body.toString())
                    );

                  boolean success = tplEngine.getValue(
    ...
    request
      .headers()
      .add("X-Gravitee-Request-Id", UUID.toString(UUID.random()));
          ...
          header ->
            request
              ...
              .add(
                ...
                context
                  .getTemplateEngine()
                  .getValue(header.getValue(), String.class)
              )
        );
    }
    ...
    if (
      ...
      request.putHeader(
        io.vertx.core.http.HttpHeaders.CONTENT_LENGTH,
